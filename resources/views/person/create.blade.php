                    ...
                    <form action="{{route('person.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-6">
                            ...
                            <span class="sm:col-span-3">
                                ...
                                <input class="block w-full" type="file" name="image" id="image" value="{{old('image')}}">
                            </span>
                            <span class="sm:col-span-3">
                        ...
                        <div class="mt-6 flex items-center justify-end gap-x-6">
                            ...
                            <button class="bg-blue-600 text-black py-2 px-3 rounded-full" type="submit">Save</button>
                        </div>
